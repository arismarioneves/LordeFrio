...
<html lang="pt-BR">
	...
	<body>
		<div id="root">
			<header class="app-header">
				<div class="wrapper">
					...
					<nav>
						...
						<a class="icon-link" href="https://github.com/arismarioneves/LordeFrio/" target="_blank" title="Github">
			...
			<section id="hero">
				<h2>
					<strong><em>LORDE&gt;</em>FRIO</strong>
				</h2>
			</section>
			<section id="summary">
				<div class="wrapper">
					<div class="summary-card">
						<div class="card">
							...
							<div class="stat-text">
								...
								fclose($fp);
								?>
								<div>aproximadamente</div>
								<div class="number"><?php echo $visitas; ?></div>
								<div>visitantes até agora</div>
							</div>
							<div class="stat-text"></div>
						</div>
					</div>
					<div class="blabla">
						<h3>Ajude a combater o LORDE><i>FRIO</i></h3>
						<h4>Seja um <b>Herói</b>!</h4>
						<pre><code>Chave PIX: </code><br><code class="import-url">db0c57cf-95a8-4f7b-a3f9-102e03621afb</code></pre>
						<div class="run"></div>
					</div>
				</div>
			</section>
			<footer>
				<div class="wrapper">
					...
					<p><em>Mari05liM</em> | <a href="mailto:mariodev@outlook.com.br">mariodev@outlook.com.br</a></p>
					<p style="font-size:20px"></p>
					<p style="margin-top: 2rem;">
						<button class="instatus"><span class="status-dot" style="background-color: rgb(15, 186, 85);"></span><span class="status-text">Online</span></button>
					</p>
				</div>
			</footer>
		</div>
